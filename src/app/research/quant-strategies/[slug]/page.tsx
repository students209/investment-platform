...
import { getReport, getQuantStrategyReports } from '@/lib/hugo'
...
export default async function QuantStrategyReportDetail({
  params,
}: {
  params: Promise<{ slug: string }>
}) {
  const { slug } = await params
  const report = await getReport('quant-strategy', slug)
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* 返回链接 */}
      <Link 
        href="/research/quant-strategies" 
